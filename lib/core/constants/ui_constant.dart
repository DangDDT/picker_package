...
const kDefaultBorder = Border.fromBorderSide(BorderSide(color: Color(0xFFE5E5E5), width: 1, style: BorderStyle.solid));

const kDefaultDecoration = BoxDecoration(color: Colors.white, borderRadius: kDefaultRadius, border: kDefaultBorder);

const kDefaultShadow = BoxShadow(color: Color(0x0D000000), offset: Offset(0, 4), blurRadius: 16);
