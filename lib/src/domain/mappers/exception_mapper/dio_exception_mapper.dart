...
//                 ? _errorResponseMapper.mapData(exception.response!.data!)
...
//           // Logger.logWarning("Not handled NoInternetException", name: "DioExceptionMapper");
//           if (exception is SocketException) {
//             return RemoteException(kind: RemoteExceptionKind.network, rootException: exception);
//           }
//           if (exception is HttpException) {
//             return RemoteException(kind: RemoteExceptionKind.noInternet, rootException: exception);
//           }
